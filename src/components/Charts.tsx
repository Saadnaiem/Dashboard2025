            ...
            <ChartCard title="Performance Index">
                <ResponsiveContainer width="100%" height={400}>
                    <PieChart>
                        ...
                        {/* FIX: Cast Legend props to any to resolve property 'payload' does not exist error. */}
                        <Legend {...({ payload: legendPayload, formatter: renderLegendText, verticalAlign: "bottom", height: 36 } as any)} />
            ...
            <ChartCard title="Brand Leaderboard" className="lg:col-span-2">
                <ResponsiveContainer width="100%" height={400}>
                    <BarChart layout="vertical" data={data.top10Brands} margin={{ left: isMobile ? 80 : 120, right: 80, top: 20, bottom: 20 }}>
                        ...
                        <Tooltip content={<CustomTooltip />} />
                        {/* FIX: Cast Legend props to any to resolve property 'payload' does not exist error. */}
                        <Legend {...({ payload: legendPayload, formatter: renderLegendText } as any)} />
